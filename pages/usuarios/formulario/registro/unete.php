...
<head>
  ...
  <title>Política de Privacidad - Search Job</title>
...
<div class="container-menu">
  <div class="cont-menu">
    <nav><br>
      ...
      <a href="../../../../pages/vistas/categorias.html" data-texto="categorias">Categorías</a>
      <a href="../../../../pages/vistas/notificaciones.html" data-texto="bandeja">Bandeja de entrada</a>
      <a href="../../../../pages/vistas/adminpedidos.html" data-texto="admin">Administrador de pedidos</a>
      <a href="../../../../pages/vistas/configuracion.html" data-texto="config">Configuración</a>
  ...
  <div class="overlay" id="privacyPopup">
    <div class="popup">
      ...
      <p>Para continuar, debes aceptar nuestra política de privacidad que asegura el uso adecuado de tus datos.</p>
      <button class="btn" onclick="aceptarPolitica()">Aceptar y continuar</button>
    </div>
  </div>-->
  ...
  <div id="mainContent">
    <h3>Formulario de Registro</h3>
      ...
      <label>
    <input type="checkbox" name="trabajador" value="1"> 
    Voy a ser trabajador
      </label>
