...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $gmail = mysqli_real_escape_string($conex, $_POST['gmail']);
    $contrasena = mysqli_real_escape_string($conex, $_POST['contrasena']);

    // Suponiendo que en la tabla usuarios la columna correo se llama gmail y password contrasena
    $sql = "SELECT dni, nombre, telefono, localidad, contrasena FROM usuarios WHERE gmail = '$gmail' LIMIT 1";
    $resultado = mysqli_query($conex, $sql);

    if ($resultado && mysqli_num_rows($resultado) == 1) {
        $usuario = mysqli_fetch_assoc($resultado);
        // Aquí compara la contraseña. Si la tienes en texto plano (no recomendado), así:
...
<head>
  ...
  <title>Iniciar sesión - Search Job</title>
 ...
 ul {
  text-align: left;
	...
	.cont-menu nav a{
		...
		padding: 20px;
    text-align: center;
		color: #c7c7c7 !important;/*color de letras*/
...
<div class="container-menu">
	...
	<div class="cont-menu">
      ...
      <a href="../../../../pages/vistas/premium.html" data-texto="premium">Premium</a>
      <a href="../../../../pages/vistas/categorias.php"data-texto="categorias" >Categorías</a>
      <a href="../../../../pages/vistas/notificaciones.html"data-texto="bandeja" >Bandeja de entrada</a>
      <a href="../../../../pages/vistas/adminpedidos.html" data-texto="adminPedidos" >Administrador de pedidos</a>
      <a href="../../../../pages/vistas/configuracion.html" data-texto="configuracion" >Configuracion</a>
      <a href="../../../../pages/vistas/ayuda.html" data-texto="ayuda">Ayuda</a>
        </nav>
 ...
 <h2><center>Iniciar sesión</center></h2>
  <?php if ($error): ?>
    ...
    <?php endif; ?>
    <div class="card">
      <center><img src="../../../../imagenes/perfiles/cliente-logo.jpg" alt="cliente"></center>
      </div>
     <form action="validacion.php" method="POST">
      ...
      <a href="../../../registro/Recuperacion-contra.html" class="forgot-password"><u>¿Has olvidado tu contraseña?</u></a>
         <br>
...
function aplicarConfiguracionGlobal() {
    ...
    if (tema === 'oscuro') {
        ...
        document.querySelectorAll('input, button, label, a').forEach(el => {
            el.style.color = '#fff';
    ...
    const textos = {
        es: {
            ...
            menu: ["Inicio","Premium","Categorías","Bandeja de entrada","Administrador de pedidos","Configuración","Ayuda"]
        },
        en: {
            titulo: "Login",
            gmail: "Email:",
            ...
            menu: ["Home","Premium","Categories","Inbox","Order Manager","Settings","Help"]
        },
        pt: {
            titulo: "Entrar",
            gmail: "Email:",
            ...
            menu: ["Início","Premium","Categorias","Caixa de entrada","Gerenciador de pedidos","Configurações","Ajuda"]
        }
    };
    ...
    if (h2) h2.textContent = t.titulo;

    // Cambiar labels
    document.querySelectorAll('#mainContent label').forEach(label => {
        if (label.innerText.includes("Gmail") || label.innerText.includes("Email")) label.textContent = t.gmail;
        if (label.innerText.includes("Contraseña") || label.innerText.includes("Password") || label.innerText.includes("Senha")) label.textContent = t.contrasena;
    });
