...
if (!isset($_SESSION['dni'])) {
    header("Location: /searchjob/pages/usuarios/login-cliente.php");
    exit();
}

$dni = $_SESSION['dni'];
$sql = "SELECT u.nombre, u.telefono, u.localidad, u.foto_perfil 
        FROM usuarios u 
        WHERE u.dni = ?"; 
...
$sqlCheck = "SELECT 1 FROM trabajador WHERE identificador = ?";
...
input[type="file"] {
    color: transparent;   /* oculta el texto al*/
}
...
<header>
  ...
  <div class="container-menu">
    <div class="cont-menu">
    <nav><br>
  <a href="../index-u.php" data-text="home">Home</a>
  <a href="../vistas/categorias.php" data-text="categorias">Categorías</a>
  <a href="../vistas/notificaciones.php" data-text="bandeja">Bandeja de entrada</a>
        <a href="../vistas/adminPedidos.php" data-texto="adminPedidos">Pedidos</a>
<a href="../vistas/chat.php">Chat</a>
  <a href="../vistas/configuracion.php" data-text="configuracion">Configuración</a>
  <a href="../vistas/ayuda.php" data-text="ayuda">Ayuda</a>
</nav>
  ...
  <div id="estado-linea" class="info-item">
        <i class="fas fa-circle" style="color: green;"></i> En línea
      </div>
...
<?php if (!$isTrabajador): ?>
  <button><a href="../../trabajador/formulario/registro/formulariotrabajador.php" style="color:white">Quiero ser trabajador</a></button>
<?php endif; ?>
  </div>
...
<?php
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["nombre"], $_POST["telefono"], $_POST["localidad"])) {
  $nombre = $_POST["nombre"];
