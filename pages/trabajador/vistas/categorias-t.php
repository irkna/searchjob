...
<!--boton de barra	--------------->
  ...
  <div class="container-menu">
    ...
    <nav><br>
        ...
        <a href="chat-t.php">Chat</a>
 
        <a href="configuracion-t.php" data-texto="configuracion">Configuración</a>
        <a href="ayuda-t.html" data-texto="ayuda">Ayuda</a>
      </nav>
  ...
  <main class="search-section">
    <section class="fondo">
      ...
      <form method="GET" action="categorias-t.php" class="search-form" style="text-align:center;">
      ...
      <div class="botones-grid" style="margin-top: 30px;">
        <a href="categorias-t.php?query=Gasista" class="filtro-btn" data-texto="gasista"><i class="fas fa-fire-extinguisher"></i> Gasista</a>
        <a href="categorias-t.php?query=Electricista" class="filtro-btn" data-texto="electricista"><i class="fas fa-bolt"></i> Electricista</a>
        <a href="categorias-t.php?query=Plomero" class="filtro-btn" data-texto="plomero"><i class="fas fa-wrench"></i> Plomero</a>
        <a href="categorias-t.php?query=Pintor" class="filtro-btn" data-texto="pintor"><i class="fas fa-paint-roller"></i> Pintor</a>
        <a href="categorias-t.php?query=Cerrajero" class="filtro-btn" data-texto="cerrajero"><i class="fas fa-key"></i> Cerrajero</a>
        <a href="categorias-t.php?query=Carpintero" class="filtro-btn" data-texto="carpintero"><i class="fas fa-hammer"></i> Carpintero</a>
        <a href="categorias-t.php?query=Mecánico" class="filtro-btn" data-texto="mecanico"><i class="fas fa-car"></i> Mecánico</a>
        <a href="categorias-t.php?query=Jardinero" class="filtro-btn" data-texto="jardinero"><i class="fas fa-leaf"></i> Jardinero</a>
      </div>
    </section>
  ...
  echo "<a href='ver_perfil.php?dni=$dniUser' style='text-decoration:none; color:inherit;'>";
