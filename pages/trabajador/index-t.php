...
<!--boton de barra	--------------->
  ...
  <div class="container-menu">
   ...
   <nav><br> 
      ...
      <a href="vistas/premium-t.html" data-texto="premium">Premium</a>
      <a href="vistas/categorias-t.php"  data-texto="categorias">Categorías</a>
      <a href="vistas/notificaciones-t.php" data-texto="bandeja" >Bandeja de entrada</a>
           <a href="vistas/adminPedidos-t.php" data-texto="pedidos">Pedidos</a>
<a href="vistas/chat.php">Chat</a>
      <a href="vistas/configuracion-t.php"data-texto="configuracion" >Configuracion</a>
      <a href="vistas/ayuda-t.php" data-texto="ayuda">Ayuda</a>
        </nav>
 ...
 <div>
  <img src="../../imagenes/mingo.png" alt="mingo" class="mingo">
    ...
    <h2 data-texto="tituloPrincipal">Encuentra un profesional <br><b><span class="Arial Black">ADECUADO</span></b></h2>
      ...
      <form method="GET" action="vistas/categorias-t.php" class="search-form" style="text-align:center;">
      ...
      <div class="botones-grid" style="margin-top: 30px;">
        <a href="vistas/categorias-t.php?query=Gasista" class="filtro-btn" data-texto="gasista"><i class="fas fa-fire-extinguisher"></i> Gasista</a>
        <a href="vistas/categorias-t.php?query=Electricista" class="filtro-btn" data-texto="electricista"><i class="fas fa-bolt"></i> Electricista</a>
        <a href="vistas/categorias-t.php?query=Plomero" class="filtro-btn" data-texto="plomero"><i class="fas fa-wrench"></i> Plomero</a>
        <a href="vistas/categorias-t.php?query=Pintor" class="filtro-btn" data-texto="pintor"><i class="fas fa-paint-roller"></i> Pintor</a>
        <a href="vistas/categorias-t.php?query=Cerrajero" class="filtro-btn" data-texto="cerrajero"><i class="fas fa-key"></i> Cerrajero</a>
        <a href="vistas/categorias-t.php?query=Carpintero" class="filtro-btn" data-texto="carpintero"><i class="fas fa-hammer"></i> Carpintero</a>
        <a href="vistas/categorias-t.php?query=Mecánico" class="filtro-btn" data-texto="mecanico"><i class="fas fa-car"></i> Mecánico</a>
        <a href="vistas/categorias-t.php?query=Jardinero" class="filtro-btn" data-texto="jardinero"><i class="fas fa-leaf"></i> Jardinero</a>
      </div>
    </section>
